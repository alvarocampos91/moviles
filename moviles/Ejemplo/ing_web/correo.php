...
<!-- Custom Theme files -->
<link href="estilo/style.css" rel="stylesheet" type="text/css" media="all"/>
<!-- Custom Theme files -->
...
<div class="contact">
	...
	<form method="post">
		<h3>Correo Electrónico Destino</h3>
		<input type="email" placeholder="your@email.com" class="hola"  name="destinatario" required />
		...
		<?php
			if (isset($_POST['send'])){
				...
				$mail_username="TravagoWeb@gmail.com";//Correo electronico saliente ejemplo: tucorreo@gmail.com
				$mail_userpassword="travago123";//Tu contraseña de gmail
				$mail_addAddress=$_POST['destinatario'];//correo electronico que recibira el mensaje
				$template="email_template.html";//Ruta de la plantilla HTML para enviar nuestro mensaje
				
				/*Inicio captura de datos enviados por $_POST para enviar el correo */
				$mail_setFromEmail="TravagoWeb@gmail.com";
